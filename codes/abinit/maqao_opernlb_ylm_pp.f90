SUBROUTINE opernlb_ylm(choice,cplex,cplex_dgxdt,cplex_fac,dgxdtfac,dgxdtfac_sij,dimffnl,ffnl,gxfac,gxfac_sij,ia3,idir,indlmn,kpg,matblk,ndgxdtfac,nincat,nkpg,nlmn,nloalg,npw,nspinor,paw_opt,ph3d,svect,ucvol,vect)
 IMPLICIT NONE
...
CALL opernlb_ylm_ASSIST_choicee1_paw_opts3_cplexe2(cplex_dgxdt,cplex_fac,dgxdtfac,dgxdtfac_sij,dimffnl,ffnl,gxfac,gxfac_sij,ia3,idir,indlmn,kpg,matblk,ndgxdtfac,nincat,nkpg,nlmn,nloalg,npw,nspinor,paw_opt,ph3d,svect,ucvol,vect)
 RETURN
 END IF
 IF (choice .EQ. 1 .AND. paw_opt < 3 .AND. cplex .EQ. 2)  THEN
CALL opernlb_ylm_ASSIST_choicee1_paw_opti3_cplexe2(cplex_dgxdt,cplex_fac,dgxdtfac,dgxdtfac_sij,dimffnl,ffnl,gxfac,gxfac_sij,ia3,idir,indlmn,kpg,matblk,ndgxdtfac,nincat,nkpg,nlmn,nloalg,npw,nspinor,paw_opt,ph3d,svect,ucvol,vect)
 RETURN
 END IF
 IF (choice .EQ. 1 .AND. paw_opt .EQ. 3 .AND. cplex .EQ. 2)  THEN
CALL opernlb_ylm_ASSIST_choicee1_paw_opte3_cplexe2(cplex_dgxdt,cplex_fac,dgxdtfac,dgxdtfac_sij,dimffnl,ffnl,gxfac,gxfac_sij,ia3,idir,indlmn,kpg,matblk,ndgxdtfac,nincat,nkpg,nlmn,nloalg,npw,nspinor,ph3d,svect,ucvol,vect)
 RETURN
 END IF
! *************************************************************************
...
! derivative w.r.t. strain
         IF (choice .EQ. 3)  THEN
           IF (idir <= 3)  THEN
             DO ilmn = 1, nlmn
               ztab(:) = ztab(:) + ffnl(:,1,ilmn) * cmplx(dgxdtfac_(1,1,ilmn) - gxfac_(1,ilmn),dgxdtfac_(2,1,ilmn) - gxfac_(2,ilmn),kind=dp) - ffnl(:,2,ilmn) * cmplx(gxfac_(1,ilmn),gxfac_(2,ilmn),kind=dp)
             END DO

           ELSE
             DO ilmn = 1, nlmn
               ztab(:) = ztab(:) + ffnl(:,1,ilmn) * cmplx(dgxdtfac_(1,1,ilmn),dgxdtfac_(2,1,ilmn),kind=dp) - ffnl(:,2,ilmn) * cmplx(gxfac_(1,ilmn),gxfac_(2,ilmn),kind=dp)
             END DO
...
! -<G|dp/dk_(idir-1)>V<dp/dk_(idir+1)|psi>
           ...
           DO ilmn = 1, nlmn
             ztab(:) = ztab(:) + ffnl(:,fdf,ilmn) * cmplx(dgxdtfac_(1,2,ilmn),dgxdtfac_(2,2,ilmn),kind=dp) - ffnl(:,fdb,ilmn) * cmplx(dgxdtfac_(1,1,ilmn),dgxdtfac_(2,1,ilmn),kind=dp)
           END DO
...
!DIR$ LOOP COUNT MAX=554, MIN=554, AVG=554
DO lt_var_k = 1, npw, 8
DO k = lt_var_k, min(npw,lt_var_k + 8 - 1)
...
! derivative w.r.t. strain
         IF (choice .EQ. 3)  THEN
           IF (idir <= 3)  THEN
             DO ilmn = 1, nlmn
               ztab(:) = ztab(:) + ffnl(:,1,ilmn) * cmplx(dgxdtfacs_(1,1,ilmn) - gxfacs_(1,ilmn),dgxdtfacs_(2,1,ilmn) - gxfacs_(2,ilmn),kind=dp) - ffnl(:,2,ilmn) * cmplx(gxfacs_(1,ilmn),gxfacs_(2,ilmn),kind=dp)
             END DO

           ELSE
             DO ilmn = 1, nlmn
               ztab(:) = ztab(:) + ffnl(:,1,ilmn) * cmplx(dgxdtfacs_(1,1,ilmn),dgxdtfacs_(2,1,ilmn),kind=dp) - ffnl(:,2,ilmn) * cmplx(gxfacs_(1,ilmn),gxfacs_(2,ilmn),kind=dp)
             END DO
...
! -<G|dp/dk_(idir-1)>V<dp/dk_(idir+1)|psi>
           ...
           fdb = ffnl_dir_dat(2 * idir)
           DO ilmn = 1, nlmn
             ztab(:) = ztab(:) + ffnl(:,fdf,ilmn) * cmplx(dgxdtfacs_(1,2,ilmn),dgxdtfacs_(2,2,ilmn),kind=dp) - ffnl(:,fdb,ilmn) * cmplx(dgxdtfacs_(1,1,ilmn),dgxdtfacs_(2,1,ilmn),kind=dp)
           END DO
...
!$OMP DO
             DO ipw = 1, npw
               ztab(ipw) = czero
               DO ilmn = 1, nlmn
                 ztab(ipw) = ztab(ipw) + ffnl(ipw,1,ilmn) * cmplx(dgxdtfac_(1,1,ilmn) - gxfac_(1,ilmn),dgxdtfac_(2,1,ilmn) - gxfac_(2,ilmn),kind=dp) - ffnl(ipw,2,ilmn) * cmplx(gxfac_(1,ilmn),gxfac_(2,ilmn),kind=dp)
               END DO
...
!$OMP DO
             DO ipw = 1, npw
               ztab(ipw) = czero
               DO ilmn = 1, nlmn
                 ztab(ipw) = ztab(ipw) + ffnl(ipw,1,ilmn) * cmplx(dgxdtfac_(1,1,ilmn),dgxdtfac_(2,1,ilmn),kind=dp) - ffnl(ipw,2,ilmn) * cmplx(gxfac_(1,ilmn),gxfac_(2,ilmn),kind=dp)
               END DO
...
!$OMP DO
           DO ipw = 1, npw
             ztab(ipw) = czero
             DO ilmn = 1, nlmn
               ztab(ipw) = ztab(ipw) + ffnl(ipw,fdf,ilmn) * cmplx(dgxdtfac_(1,2,ilmn),dgxdtfac_(2,2,ilmn),kind=dp) - ffnl(ipw,fdb,ilmn) * cmplx(dgxdtfac_(1,1,ilmn),dgxdtfac_(2,1,ilmn),kind=dp)
             END DO
...
!$OMP DO
             DO ipw = 1, npw
               ztab(ipw) = czero
               DO ilmn = 1, nlmn
                 ztab(ipw) = ztab(ipw) + ffnl(ipw,1,ilmn) * cmplx(dgxdtfacs_(1,1,ilmn) - gxfacs_(1,ilmn),dgxdtfacs_(2,1,ilmn) - gxfacs_(2,ilmn),kind=dp) - ffnl(ipw,2,ilmn) * cmplx(gxfacs_(1,ilmn),gxfacs_(2,ilmn),kind=dp)
               END DO
...
!$OMP DO
             DO ipw = 1, npw
               ztab(ipw) = czero
               DO ilmn = 1, nlmn
                 ztab(ipw) = ztab(ipw) + ffnl(ipw,1,ilmn) * cmplx(dgxdtfacs_(1,1,ilmn),dgxdtfacs_(2,1,ilmn),kind=dp) - ffnl(ipw,2,ilmn) * cmplx(gxfacs_(1,ilmn),gxfacs_(2,ilmn),kind=dp)
               END DO
...
!$OMP DO
           DO ipw = 1, npw
             ztab(ipw) = czero
             DO ilmn = 1, nlmn
               ztab(ipw) = ztab(ipw) + ffnl(ipw,fdf,ilmn) * cmplx(dgxdtfacs_(1,2,ilmn),dgxdtfacs_(2,2,ilmn),kind=dp) - ffnl(ipw,fdb,ilmn) * cmplx(dgxdtfacs_(1,1,ilmn),dgxdtfacs_(2,1,ilmn),kind=dp)
             END DO
...
SUBROUTINE opernlb_ylm_ASSIST_choicee1_paw_opte3_cplexe2(cplex_dgxdt,cplex_fac,dgxdtfac,dgxdtfac_sij,dimffnl,ffnl,gxfac,gxfac_sij,ia3,idir,indlmn,kpg,matblk,ndgxdtfac,nincat,nkpg,nlmn,nloalg,npw,nspinor,ph3d,svect,ucvol,vect)
 IMPLICIT NONE
